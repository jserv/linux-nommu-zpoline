...
plot \
   ...
   '${OUTPUT}/out/um-mmu-lmbench-out.dat' usin (\$0-0.1):(\$1) w boxes fill patter 2 lt 1 lc rgb "green" title "um(mmu)" ,\
   '${OUTPUT}/out/um-nommu-seccomp-lmbench-out.dat' usin (\$0+0.1):(\$1) w boxes fill patter 2 lt 1 lc rgb "royalblue" title "um(nommu(s))" ,\
   '${OUTPUT}/out/um-nommu-zpoline-lmbench-out.dat' usin (\$0+0.3):(\$1) w boxes fill patter 2 lt 1 lc rgb "blue" title "um(nommu(z))"
...
plot \
   '${OUTPUT}/out/native-iperf3-out.dat' usin (\$0-0.3):(\$1/1000) w boxes fill patter 2 lt 1 lc rgb "red" title "native",\
   '${OUTPUT}/out/um-mmu-iperf3-out.dat' usin (\$0-0.1):(\$1/1000) w boxes fill patter 2 lt 1 lc rgb "green" title "um(mmu)" ,\
   '${OUTPUT}/out/um-nommu-seccomp-iperf3-out.dat' usin (\$0+0.1):(\$1/1000) w boxes fill patter 2 lt 1 lc rgb "royalblue" title "um(nommu(s))" ,\
   '${OUTPUT}/out/um-nommu-zpoline-iperf3-out.dat' usin (\$0+0.3):(\$1/1000) w boxes fill patter 2 lt 1 lc rgb "blue" title "um(nommu(z))"
